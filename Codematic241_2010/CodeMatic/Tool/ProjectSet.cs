...
namespace Codematic
{
	...
	public class ProjectSet : System.Windows.Forms.Form
	{
		...
		public static LTP.CmConfig.ProSettings setting=new LTP.CmConfig.ProSettings();	
		public ProjectSet()
		{
			//
			// Windows 窗体设计器支持所必需的
		...
		{		
			setting=LTP.CmConfig.ProConfig.GetSettings();
		...
		private void SaveSet()
		{
			...
			LTP.CmConfig.ProConfig.SaveSettings(setting);
		}
